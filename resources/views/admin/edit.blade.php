        ...
        <form action="{{ route('artists.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="artista" id="artista"
                    class="form-control @error('artista') is-invalid @enderror" value="{{ old('artist', $artist->artista)}}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nazionalita" id="nazionalita"
                    class="form-control @error('nazionalita') is-invalid @enderror" value="{{ old('nazionalita', $artist->nazionalita)}}"
            ...
            <div class="mb-3">
                ...
                <input type="date" name="prossimo_concerto" id="prossimo_concerto"
                    ...
                    value="{{ old('prossimo_concerto', $artist->prossimo_concerto)}}" placeholder="Project prossimo_concerto">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="ultimo_album" id="ultimo_album"
                    class="form-control @error('ultimo_album') is-invalid @enderror" value="{{ old('ultimo_album', $artist->ultimo_album)}}"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="ultimo_singolo" id="ultimo_singolo"
                    class="form-control @error('ultimo_singolo') is-invalid @enderror" value="{{ old('ultimo_singolo', $artist->ultimo_singolo)}}"
